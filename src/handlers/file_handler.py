...
class FileHandler:
    ...
    def __init__(self):
        self.pptx_template_path = 'C:/DEV/Py_Selenium_Script 1/assets/FYXX IUC - User List Source_GeneralTemplate.pptx'
        self.screenshots_path = 'C:/DEV/Py_Selenium_Script 1/screenshots'
    ...
    def add_screenshots_to_template(self):
        try:
            ...
            for i in range(0, len(screenshot_files), 2):
                ...
                slide.shapes.add_picture(image_path1, Inches(0.2), Inches(1), width=Inches(7), height=Inches(4))
                ...
                if i + 1 < len(screenshot_files): 
                    ...
                    slide.shapes.add_picture(image_path2, Inches(0.2), Inches(5.2), width=Inches(7), height=Inches(4)) 
    ...
    def generate_file_path(self):
        try:
            ...
            if unique_filename:
                ...
                file_path = f"C:\DEV\Py_Selenium_Script 1\IUCs\{unique_filename}.pptx"
                return file_path
            else:
                return None
        except Exception as e:
